...
use crate::cursor_grid::{manhattan, Coord};

type Num = u32;
type Universe = Vec<Coord>;

pub fn day11(lines: impl Iterator<Item = impl AsRef<str>>, multiplier: u32) -> Num {
...
fn expand_universe(mut universe: &mut Universe, multiplier: u32) {
